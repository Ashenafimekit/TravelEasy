  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex flex-col justify-center items-center bg-[#F5F5F5] w-4/5">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-10 w-full px-4">
          <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-lg w-full md:w-3/4">
            <h1 className="font-bold text-lg mb-1">Customer First</h1>
            <p className="text-sm">
              We put our customers at the heart of everything we do.
            </p>
            <div className="my-3">
              <img src={reliability} alt="" className="h-20 w-30" />
            </div>
          </div>
          <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-lg w-full md:w-3/4">
