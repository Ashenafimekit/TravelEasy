    ...
    <div className="flex flex-col items-center justify-center mt-5 bg-black text-white">
      <div className="flex flex-col items-center justify-center gap-5 p-5 text-center">
        ...
        <Link to="/contact">
          <motion.button
            ...
            className="bg-lightGray rounded-xl text-black w-32 h-10 hover:bg-white"
          >
            Contact us
          </motion.button>
        </Link>
      ...
      <div className="flex flex-col w-full md:w-3/4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-sm md:text-base mb-5">
          <Link
            to="/"
            className="bg-black border border-white border-dotted p-2"
          >
            TravelEasy
          </Link>
          ...
          <div className="flex space-x-4">
            <motion.div whileHover={{scale: 1.2}}>
              <FacebookIcon fontSize="medium" className="cursor-pointer" />
            </motion.div>
            <motion.div whileHover={{scale: 1.2}}>
              <InstagramIcon fontSize="medium" className="cursor-pointer" />
            </motion.div>
            <motion.div whileHover={{scale: 1.2}}>
              <XIcon fontSize="medium" className="cursor-pointer" />
            </motion.div>
          </div>
        </div>
      </div>
